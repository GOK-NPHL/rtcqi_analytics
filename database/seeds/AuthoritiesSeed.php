...
class AuthoritiesSeed extends Seeder
{
    ...
    public function run()
    {
        $permmissions = array(
            ...
            array('name' => 'submissions_section', 'group' => 'system', 'created_at' => new \dateTime, 'updated_at' => new \dateTime),
            ...
            array('name' => 'partners_section', 'group' => 'system', 'created_at' => new \dateTime, 'updated_at' => new \dateTime),
            array('name' => 'view_partners', 'group' => 'partner', 'created_at' => new \dateTime, 'updated_at' => new \dateTime),
            array('name' => 'manage_partners', 'group' => 'partner', 'created_at' => new \dateTime, 'updated_at' => new \dateTime),
