        ...
        <React.Fragment>
            ...
            <div style={rowStle} className="row">
                <div className="col-sm-6  col-xm-6 col-md-6">
                    <img style={{ "width": "100%", "height": "30%" }} src={props.chart1}></img>
                </div>
                <div className="col-sm-6 col-xm-6 col-md-6">
                    <img style={{ "width": "100%", "height": "100%" }} src={props.chart2}></img>
                </div>
            </div>
...
const el = document.getElementById('MEReport');
if (el) {
    let domValues = [];
    let domValuesMap = {};
    ...
    createRoot(el).render(<MEReport {...props} />);
}
